  ...
  />
      ...
      >
        <svg
          ...
          fill="#ffffff"
        >
          <path d="M16 .396C7.39.396.396 7.39.396 16c0 2.82.738 5.57 2.138 8.01L.24 31.604l7.77-2.042A15.55 15.55 0 0016 31.604c8.61 0 15.604-6.994 15.604-15.604C31.604 7.39 24.61.396 16 .396z" />
        </svg>
      </a>
    </>
  );
